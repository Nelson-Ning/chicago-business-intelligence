...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/healthy-matter-348909:us-central1:mypostgres sslmode=disable port = 5432"
